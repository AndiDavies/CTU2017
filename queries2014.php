...
$objPHPExcel->getProperties()->setCreator("Richard Dudley")
							 ...
							 ->setDescription("Complete export of submitted information from the CTU Activity Report round ending October 2014")
							 ->setKeywords("CTU php")
...
INNER JOIN `sdonihr`.`ctu_activityreporting`
ON `ctu_report_section1`.`report_id` = `ctu_activityreporting`.`report_id`
INNER JOIN `sdonihr`.`ctu_details` 
ON `ctu_activityreporting`.`ctu_id` = `ctu_details`.`ctu_id`
WHERE ctu_activityreporting.period = '201314'
...
From
sdonihr.ctu_report_section2current
INNER JOIN `sdonihr`.`ctu_activityreporting`
ON `ctu_report_section2current`.`report_id` = `ctu_activityreporting`.`report_id`
INNER JOIN `sdonihr`.`ctu_details` 
ON `ctu_activityreporting`.`ctu_id` = `ctu_details`.`ctu_id`
Inner Join
  sdonihr.ctu_objectives On sdonihr.ctu_activityreporting.ctu_id = sdonihr.ctu_objectives.ctu_id 
And
    sdonihr.ctu_report_section2current.objective_rank = sdonihr.ctu_objectives.objective_rank
WHERE ctu_activityreporting.period = '201314'
Order By
...
From
 sdonihr.ctu_report_section2planned  
Inner Join sdonihr.ctu_activityreporting
	On sdonihr.ctu_report_section2planned.report_id = sdonihr.ctu_activityreporting.report_id
Inner Join sdonihr.ctu_details
	On sdonihr.ctu_details.ctu_id = sdonihr.ctu_activityreporting.ctu_id
WHERE ctu_activityreporting.period = '201314'
Order By
...
From
 sdonihr.ctu_report_section2 Inner Join
sdonihr.ctu_activityreporting
	On sdonihr.ctu_report_section2.report_id = sdonihr.ctu_activityreporting.report_id
Inner Join sdonihr.ctu_details
...
$sql="Select
  sdonihr.ctu_details.ukcrc As `CTU ID`,
  sdonihr.ctu_details.name,
  sdonihr.ctu_report_section3_inprog.previousoutlineproposalsshortlisted,
  sdonihr.ctu_report_section3_inprog.previousoutlineproposalsrejected,
  sdonihr.ctu_report_section3_inprog.currentoutlineproposalssubmitted,
  sdonihr.ctu_report_section3_inprog.currentoutlineproposalsshortlisted,
  sdonihr.ctu_report_section3_inprog.currentoutlineproposalsrejected,
  sdonihr.ctu_report_section3_inprog.currentoutlineproposalsdecisionpending,
  sdonihr.ctu_report_section3_inprog.previousfullproposalsfunded,
  sdonihr.ctu_report_section3_inprog.previousfullproposalsrejected,
  sdonihr.ctu_report_section3_inprog.currentfullproposalssubmitted,
  sdonihr.ctu_report_section3_inprog.currentfullproposalsfunded,
  sdonihr.ctu_report_section3_inprog.currentfullproposalsfundwithchange,
  sdonihr.ctu_report_section3_inprog.currentfullproposalsdeferred,
  sdonihr.ctu_report_section3_inprog.currentfullproposalsresubmitting,
  sdonihr.ctu_report_section3_inprog.currentfullproposalstransferred,
  sdonihr.ctu_report_section3_inprog.currentfullproposalsrejected,
  sdonihr.ctu_report_section3_inprog.currentfullproposalsdecisionpending,
  sdonihr.ctu_report_section3_inprog.nihrprojectsstartedduringperiod,
  sdonihr.ctu_report_section3_inprog.totalcurrentnihrprojects
From sdonihr.ctu_report_section3_inprog
Inner Join
sdonihr.ctu_activityreporting
	On sdonihr.ctu_report_section3_inprog.report_id = sdonihr.ctu_activityreporting.report_id
Inner Join sdonihr.ctu_details
	On sdonihr.ctu_activityreporting.ctu_id = sdonihr.ctu_details.ctu_id
WHERE ctu_activityreporting.period = '201314'
Order By
...
while ($result=mysql_fetch_array($qry))
{
	$objPHPExcel->setActiveSheetIndex(6)
				...
				->setCellValue('R'.$rowcount, '')
				->setCellValue('S'.$rowcount, '')
				->setCellValue('T'.$rowcount, '');
$rowcount++;
}
...
$sql="Select
  sdonihr.ctu_details.ukcrc As `CTU ID`,
  sdonihr.ctu_details.name,
  sdonihr.ctu_report_section3b_inprog.totalunitincomefromnihrfundedprojects,
  sdonihr.ctu_report_section3b_inprog.totalunitincomefromnihrfundedprojectsmeetoffset
From sdonihr.ctu_report_section3b_inprog
  Inner Join
sdonihr.ctu_activityreporting
	On sdonihr.ctu_report_section3b_inprog.report_id = sdonihr.ctu_activityreporting.report_id
Inner Join sdonihr.ctu_details
	On sdonihr.ctu_activityreporting.ctu_id = sdonihr.ctu_details.ctu_id
WHERE ctu_activityreporting.period = '201314'
Order By
...
$sql="Select
  sdonihr.ctu_details.ukcrc As `CTU ID`,
  sdonihr.ctu_details.name,
  sdonihr.ctu_report_section3bclosed_inprog.closed_rank,
  sdonihr.ctu_report_section3bclosed_inprog.title,
  sdonihr.ctu_report_section3bclosed_inprog.programme,
  sdonihr.ctu_report_section3bclosed_inprog.reference,
  sdonihr.ctu_report_section3bclosed_inprog.reason
From
  sdonihr.ctu_report_section3bclosed_inprog Inner Join
sdonihr.ctu_activityreporting
	On sdonihr.ctu_report_section3bclosed_inprog.report_id = sdonihr.ctu_activityreporting.report_id
Inner Join sdonihr.ctu_details
	On sdonihr.ctu_activityreporting.ctu_id = sdonihr.ctu_details.ctu_id
WHERE ctu_activityreporting.period = '201314'
Order By
...
$sql="Select
  sdonihr.ctu_details.ukcrc As `CTU ID`,
  sdonihr.ctu_details.name,
  sdonihr.ctu_report_section3b_inprog.furthercommentsonnihrapplications,
  sdonihr.ctu_report_section3b_inprog.wouldyoulikechangetofunding,
  sdonihr.ctu_report_section3b_inprog.fundingchangesupport
From
sdonihr.ctu_report_section3b_inprog
Inner Join
sdonihr.ctu_activityreporting
	On sdonihr.ctu_report_section3b_inprog.report_id = sdonihr.ctu_activityreporting.report_id
Inner Join sdonihr.ctu_details
...
From
 sdonihr.ctu_report_section4

 Inner Join
sdonihr.ctu_activityreporting
	On sdonihr.ctu_report_section4.report_id = sdonihr.ctu_activityreporting.report_id
Inner Join sdonihr.ctu_details
	On sdonihr.ctu_activityreporting.ctu_id = sdonihr.ctu_details.ctu_id
WHERE ctu_activityreporting.period = '201314'
Order By
